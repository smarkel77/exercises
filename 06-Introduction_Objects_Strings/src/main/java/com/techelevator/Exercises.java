...
public class Exercises {
	...
	public String extraEnd(String str) {
		...
		String newWord = str.substring(wordLength);
	...
	public String left2(String str) {
		...
		String minusFirstTwo = str.substring(str.length() - (str.length() - 2));
		return minusFirstTwo + firstTwo;
	}
	...
	public boolean hasBad(String str) {
		...
		if (str.length() >= 4) {
			if (tester.equals(str.substring(0, 3))) {
				return true;
			} else if (str.length() == 4 && tester.equals(str.substring(1))) {
				return true;
			} else if (tester.equals(str.substring(1, 4))) {
				return true;
			}
			return false;
		} else if (str.length() == 3) {
			return tester.equals(str);
		}
		return false;
	}
	...
	public String stringSplosion(String str) {
		...
		for (int i = 0; i <= str.length() - 1; i++) {
			newString = str.substring(0, str.length() - i) + newString;
		}
		return newString;
	}
